...
export default function Overview() {
 ...
 <h2>What works today</h2><p>The introduction, English AI matching through DeepSeek, catalog filters, agent records, live evidence checks, trial preparation, browser-local shortlist, bulk export and snapshot API are implemented. AI discovery retrieves published descriptions and requires fresh Graph evidence before ranking Sepolia and Arc candidates. It does not run the selected agent.</p>
