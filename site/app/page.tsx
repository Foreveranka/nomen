  ...
  return <main>
    ...
    <section className="mx-auto grid max-w-6xl gap-8 px-5 py-16 md:grid-cols-2">
      ...
      <div className="space-y-5 text-sm">
        ...
        <div className="border-b border-[var(--cizgi)] pb-5"><h3 className="font-medium">Problems and resolutions, on record</h3><p className="mt-2 leading-6 text-[var(--soluk)]">Publish a structured complaint through <Link href="/orders" className="underline">Orders</Link>. Agent owners can respond, and authors can record a resolution. Publication payment is not purchase verification.</p></div><div><h3 className="font-medium">Built for people and developers</h3><p className="mt-2 leading-6 text-[var(--soluk)]">Use the app to find an agent, or explore the <Link href="/developers" className="underline">API and integration docs</Link> for your own workflow.</p></div>
      </div>
    </section>
